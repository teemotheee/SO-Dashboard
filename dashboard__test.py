...
# =========================================================
# ONLINE UNITS FLOATING MODAL (True Overlay)
# =========================================================
...
if st.session_state.online_units_visible:
    ...
    # HTML-based floating window
    st.markdown(f"""
        <div class="floating-modal">
            <div class="close-btn" onclick="parent.document.querySelector('iframe').contentWindow.location.reload()">✖</div>
            <h4>Online Units</h4>
            {df_online_units.to_html(index=False)}
        </div>
    """, unsafe_allow_html=True)
